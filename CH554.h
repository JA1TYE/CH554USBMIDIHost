...
#define ROM_CMD_ERASE     0x8E      // WriteOnly: flash-ROM sector erase operation command, for changing all ROM bit of 1KBytes from 0 to 1
...
/* USB device class */
#define USB_SUB_CLASS_MIDI      0x03
